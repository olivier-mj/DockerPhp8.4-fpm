...
Image Docker basée sur PHP 8.5-fpm avec des outils et extensions utiles pour le développement web moderne.
...
docker build -t php85-fpm .

# Vérifier les extensions chargées
docker run --rm php85-fpm php -m | grep -E 'apcu|imagick|redis|xdebug'

# Lancer le conteneur pour le développement
docker run -d -p 9000:9000 -v $(pwd):/var/www php85-fpm
```
...
# DockerPhp8.5-fpm (English)

Docker image based on PHP 8.5-fpm with useful tools and extensions for modern web development.
